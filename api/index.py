...
This lightweight deployment adapter keeps the original
LangGraph + ChromaDB + SentenceTransformer implementation
inside support_assistant/graph.py untouched.

The Vercel function intentionally does not import the heavy
ML/RAG packages.
"""
...
def load_policy_documents():
    """
    Load the policy text files from support_assistant/docs.
    """
...
def retrieve_policy_documents(
    ...
    using lightweight word-overlap scoring.

    This avoids importing SentenceTransformer,
    PyTorch, or ChromaDB into the Vercel function.
    """
...
def classify_intent(query: str) -> str:
    """
    Match the original project's required
    offline keyword classification behavior.
    """
